...
function crearUsuario () {
    ...
    let datos = {correo_us, nombre_us, primer_apellido_us, segundo_apellido_us, celular_us, contrasenna_us}
    
    console.log(correo_us, nombre_us, primer_apellido_us, celular_us, contrasenna_us);

    if (correo_us != "" && nombre_us != "" && primer_apellido_us != "" && celular_us != "" && contrasenna_us != "") {
...
async function mostrarUsuarios() {
  ...
  async function actualizarUsuario() {
    ...
    const respuesta = await fetch(`/usuarios/${id_us}`, {
      ...
      body: JSON.stringify({ correo_us, nombre_us, primer_apellido_us, segundo_apellido_us, celular_us, contrasenna_us }),
    });
