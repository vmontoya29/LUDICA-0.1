...
router.put('/:id/', async function (request, response) {
  ...
  try {
    ...
    const result = await connection.execute(
      'UPDATE usuarios SET nombre_us = :nombre, correo_us = :correo, primer_apellido_us = :primer_apellido, segundo_apellido_us = :segundo_apellido, celular_us = :celular, contrasenna_us = :contraseña, rol_us = :rol, WHERE id_us = :id',
      { 
        id: id_us,
        correo: correo_us,
        nombre: nombre_us,
